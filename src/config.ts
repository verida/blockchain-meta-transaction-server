...
export default class Config {
     ...
     */
    public static customParams(contractName: TContractNames, paramName: any, paramData: any) {
        /*
        switch(paramName) {
            case 'delegateType':
     ...
     */
    public static async isRequestValid(contractName: TContractNames, req: any) {
