...
export const attributes : AttributeType[] = [
  {
    name: `did/pub/${keyAlgorithm[0]}/${keyPurpose[0]}/${encoding[0]}`,
    value: `${pubKeyList[0]}?context=${contextList[0]}`,
    validity: 86400
  }, 
  {
    name: `did/pub/${keyAlgorithm[1]}/${keyPurpose[1]}/${encoding[1]}`,
    value: `${pubKeyList[1]}?context=${contextList[1]}`,
    validity: 86400
  },
  {
    name: `did/pub/${keyAlgorithm[2]}/${keyPurpose[2]}/${encoding[2]}`,
